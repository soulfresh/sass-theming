...
+ **@function dropdown-arrow-icon** Generate a dropdown arrow image.
...
| Name     | Type                                                           | Description             | Default |
| :------- | :------------------------------------------------------------- | :---------------------- | :------ |
| `$color` | **[Color](https://sass-lang.com/documentation/values/colors)** | The color of the arrow. | -       |
...
| Name                          | Type                                                               | Description                         | Default |
| :---------------------------- | :----------------------------------------------------------------- | :---------------------------------- | :------ |
| `$class`                      | **[String](https://sass-lang.com/documentation/values/strings)**   | The class name that can be used to  |         |
| simulate the active state.    | -                                                                  |                                     |         |
| `$global`                     | **[Boolean](https://sass-lang.com/documentation/values/booleans)** | Whether to the class name is global |         |
